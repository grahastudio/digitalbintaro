<div class="card">
  ...
  <div class="card-body">
    ...
    $no_invoice = date('dmY') . strtoupper(random_string('alnum', 5));
    ?>
    ...
    <fieldset class="form-group">
      <div class="row">
        <legend class="col-form-label col-sm-3 pt-0">Status Pembayaran</legend>
        <div class="col-sm-9">
          <div class="custom-control custom-radio">
            <input type="radio" id="customRadio1" name="status_invoice" class="custom-control-input" value="Lunas">
            <label class="custom-control-label" for="customRadio1">Lunas</label>
          </div>
          <div class="custom-control custom-radio">
            <input type="radio" id="customRadio2" name="status_invoice" class="custom-control-input" value="Hutang">
            <label class="custom-control-label" for="customRadio2">Hutang</label>
          </div>
        </div>
      </div>
    </fieldset>
