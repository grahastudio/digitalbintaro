<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6">
                <input type="text" name="product_price" class="form-control" placeholder="Harga Produk">
            ...
            <div class="col-lg-6">
                <select name="category_id" class="form-control form-control-chosen">
                    ...
                    <?php foreach ($category_product as $category_product) { ?>
                        <option value="<?php echo $category_product->id ?>">
        ...
        <div class="col-lg-6">
            <textarea class="form-control" name="product_desc" id="summernote"></textarea>
        </div>
        </div>
